				...
				<div class="col pb-5" id="new12" >
								...
								<img src="{{asset('uploads/news/'.$new->image)}}" style="width: 100%;" class="mb-3">
									...
									<article style="padding: 20px;">
										...
										<h4 class="text-color-dark custom-text-8 font-weight-bold mb-3 appear-animation animated fadeInRightShorter appear-animation-visible" data-appear-animation="fadeInRightShorter" data-appear-animation-delay="400" style="animation-delay: 400ms;"><a href="{{url('news')}}/{{(Str::slug($new->title))}}/{{$new->id}}" class="text-color-dark text-color-hover-primary">{{$new->title}}</a></h4>
										...
										<a href="{{url('news')}}/{{(Str::slug($new->title))}}/{{$new->id}}" class="text-color-primary text-color-hover-secondary custom-text-4 font-weight-bold text-decoration-underline appear-animation animated fadeInRightShorter appear-animation-visible" data-appear-animation="fadeInRightShorter" data-appear-animation-delay="800" style="animation-delay: 800ms;">Read More</a>
									</article>
								</div>
							</div>
						@endif
