	...
	<div class="container">
		...
		<!--begin::Form-->
			<div class="row">
				<div class="col-md-12">
					<div class="box">
						<form method="post" action="{{route('admin.gallerystore')}}" enctype='multipart/form-data'>
							@csrf
							<div class="box-content">
							<div class="form-group-select">
								<label for="select1" class="col-sm-3 col-lg-2 control-label">Gallery Title:<span style="color: #a94442;">*</span></label>
								<div class="col-sm-6 col-lg-4 controls">
									<select name="gallerytitle_id" class="form-control" data-rule-required="true">
										<option value="">- - Please Select - -</option>
										@foreach ($gallerytile as $title)
											<option value="{{$title->id}}">{{$title->name}}</option>
										@endforeach
									</select>
									<span class="text-danger">
										@error("gallerytitle_id")
										{{$message}}
										@enderror
									</span>
								</div>
