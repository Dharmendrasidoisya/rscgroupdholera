...
<div class="d-flex flex-column flex-row-fluid wrapper" id="kt_wrapper">
	...
	<div class="container">
		<div class="row rowcomp">
			...
			<h3 class="card-title">Only view Gallery</h3>
		</div>							
		<div class="row">
			<div class="col-md-12">
				<div class="box">
					...
					@csrf
						<div class="box-content">
							...
							<div class="form-group-select">
								<label class="col-sm-3 col-lg-2 control-label" for="username">Gallery Image</label>
								<div class="col-sm-6 col-lg-4 controls">
                                <img src="{{asset('uploads/image/'.$gallery->gallery_image)}}" width="150px" height="150px">
