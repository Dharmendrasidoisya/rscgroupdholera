							...
							<div class="box-content">
								<div class="form-group-select">
									...
									<div class="col-sm-6 col-lg-4 controls">
										<input name="title" type="text"class="form-control" data-rule-required="true" data-rule-minlength="3" value="{{$new->title}}"/>
								...
								<div class="col-sm-6 col-lg-6 controls">
									  <input type="checkbox" id="1" name="leatest" value="1" {{$new->leatest == '1' ? 'checked': ''}}>
								...
								<div class="form-group-select">
									...
									<div class="col-sm-6 col-lg-4 controls">
										<input oninput="pic.src=window.URL.createObjectURL(this.files[0])"  name="image" type="file"class="form-control" data-rule-required="true" data-rule-minlength="3" value="{{$new->image}}"/>
										<label><strong style="color:red">image size 800*400</strong></label>
										<img src="{{asset('uploads/news/'.$new->image)}}" width="60px" height="60px" id="pic"  >
										<span class="text-danger">
											@error("image")
											{{$message}}
											@enderror
								...
								{{-- <div class="form-group-select">
									...
									<div class="col-sm-9 col-lg-9 controls">
										<textarea name="description" type="text"class="form-control" data-rule-required="true" data-rule-minlength="3" >{{$new->description}}</textarea>
										<span class="text-danger">
											@error("description")
											{{$message}}
											@enderror
								...
								<div class="form-group-select">
									...
									<div class="col-sm-9 col-lg-9 controls">
									<textarea type="text" class="form-control" name="long_description" value="{{$new->long_description}}"  placeholder="Enter long description" id="editor1">{{$new->long_description}}</textarea>
										<span class="text-danger">
