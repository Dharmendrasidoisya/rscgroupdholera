	...
	<div class="container">
		...
		<!--begin::Form-->
			<div class="row">
				<div class="col-md-12">
					<div class="box">
						<form method="post" action="{{route('admin.newsstore')}}" enctype='multipart/form-data'>
							@csrf
							<div class="box-content">
								<div class="form-group-select">
									<label class="col-sm-3 col-lg-2 control-label" for="title">Title<span style="color: #a94442;">*</span></label>
									<div class="col-sm-6 col-lg-4 controls">
										<input name="title" type="text"class="form-control" data-rule-required="true" data-rule-minlength="3" value="{{old('title')}}"/>
								...
								<div class="col-sm-6 col-lg-6 controls">
									  <input type="checkbox" id="1" name="leatest" value="1">
								...
								<div class="form-group-select">
									...
									<div class="col-sm-6 col-lg-4 controls">
										<input name="image" type="file" class="form-control"  value="{{old('image')}}" data-rule-required="true" data-rule-minlength="3" oninput="pic.src=window.URL.createObjectURL(this.files[0])"/>
										<img id="pic"  />
								...
								{{-- <div class="form-group-select">
									...
									<div class="col-sm-9 col-lg-9 controls">
										<textarea name="description" type="text"class="form-control" value="{{old('description')}}"  data-rule-required="true" data-rule-minlength="3" value="{{old('description')}}"></textarea>
										<span class="text-danger">
											@error("description")
											{{$message}}
											@enderror
								...
								<div class="form-group-select">
									...
									<div class="col-sm-9 col-lg-9 controls">
									<textarea type="text" class="form-control" name="long_description" value="{{old('about_description')}}"  placeholder="Enter long description" id="editor1"></textarea>
										<span class="text-danger">
