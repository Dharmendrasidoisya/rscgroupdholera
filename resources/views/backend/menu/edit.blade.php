...
<div class="d-flex flex-column flex-row-fluid wrapper" id="kt_wrapper">
	...
	<div class="container">
		...
		<div class="row">
			<div class="col-md-12">
				<div class="box">
					<form method="post" action="{{route('admin.menuupdate',$menu->id)}}" enctype='multipart/form-data'>
						@csrf
						<div class="box-content">
							<div class="form-group-select">
								...
								<img src="{{asset('uploads/plot/'.$menu->menu_name)}}" width="50px">
									<input name="menu_name" type="file" class="form-control" data-rule-required="true" data-rule-minlength="3" value="{{$menu->menu_name}}"/>
