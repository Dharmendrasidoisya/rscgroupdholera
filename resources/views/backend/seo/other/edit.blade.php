...
<div class="d-flex flex-column flex-row-fluid wrapper" id="kt_wrapper">
	...
	<div class="container">
		...
		<!--begin::Form-->
		<form method="post" action="{{route('admin.seo.other.update',$other->id)}}">
							@csrf
			<div class="row">
				<div class="col-md-12">
					<div class="box">
							<div class="box-content">
								...
								<div class="form-group-select">
									...
									<div class="col-sm-6 col-lg-4 controls">
										<input name="meta_title" type="text"class="form-control" data-rule-required="true" value="{{$other->meta_title}}" data-rule-minlength="3" placeholder="Meta Title"/>
										<span class="text-danger">
											@error("meta_title")
											{{$message}}
											@enderror
								...
								<div class="form-group-select">
									...
									<div class="col-sm-6 col-lg-4 controls">
										<input name="keyword" type="text"class="form-control" data-rule-required="true" data-rule-minlength="3" placeholder="Key Word" value="{{$other->keyword}}" />
										<span class="text-danger">
											@error("keyword")
											{{$message}}
											@enderror
								...
								<div class="form-group-select">
									...
									<div class="col-sm-6 col-lg-4 controls">
										<textarea name="description" type="text"class="form-control" data-rule-required="true" data-rule-minlength="3" placeholder="Description..." value="{{$other->description}}" rows="6">{{$other->description}}</textarea>
										<span class="text-danger" >
											@error("description")
											{{$message}}
											@enderror
								...
								<div class="form-group-select">
									...
									<div class="col-sm-6 col-lg-4 controls">
										<input name="canonical" type="text"class="form-control" data-rule-required="true" data-rule-minlength="3" placeholder="Canonical..." value="{{$other->canonical}}"/>
										<span class="text-danger">
											@error("canonical")
											{{$message}}
											@enderror
