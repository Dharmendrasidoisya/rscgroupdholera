...
<div class="d-flex flex-column flex-row-fluid wrapper" id="kt_wrapper">
	...
	<div class="container">
		<div class="row">
			...
			<h3 class="card-title">Update Application SEO</h3>
		</div>
		<!--begin::Form-->
					...
					<div class="box">
							<div class="box-content">
								...
								<div class="form-group-select">
									...
									<div class="col-sm-6 col-lg-4 controls">
										<input name="meta_title" type="text"class="form-control" data-rule-required="true" value="{{$seoindustries->meta_title}}" data-rule-minlength="3" placeholder="Meta Title"/>
										<span class="text-danger">
											@error("meta_title")
											{{$message}}
											@enderror
								...
								<div class="form-group-select">
									...
									<div class="col-sm-6 col-lg-4 controls">
										<input name="keyword" type="text"class="form-control" data-rule-required="true" data-rule-minlength="3"  value="{{$seoindustries->keyword}}"  placeholder="Key Word"/>
										<span class="text-danger">
											@error("keyword")
											{{$message}}
											@enderror
								...
								<div class="form-group-select">
									...
									<div class="col-sm-6 col-lg-4 controls">
										<textarea name="description" type="text"class="form-control" data-rule-required="true" data-rule-minlength="3" placeholder="Description..." rows="6" value="{{$seoindustries->description}}"> {{$seoindustries->description}}</textarea>
										<span class="text-danger">
											@error("description")
											{{$message}}
											@enderror
								...
								<div class="form-group-select">
									...
									<div class="col-sm-6 col-lg-4 controls">
										<input name="canonical" type="text"class="form-control" data-rule-required="true" data-rule-minlength="3" placeholder="Canonical..." value="{{$seoindustries->canonical}}"/>
										<span class="text-danger">
											@error("canonical")
											{{$message}}
											@enderror
