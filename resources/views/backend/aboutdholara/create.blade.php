...
<div class="d-flex flex-column flex-row-fluid wrapper" id="kt_wrapper">
	...
	<div class="container">
		<div class="row">
			...
			<h3 class="card-title"> Add Dholera SIR</h3>
		</div>
		<!--begin::Form-->
			<div class="row">
				<div class="col-md-12">
					<div class="box">
						<form method="post" action="{{route('admin.sliderediter.store')}}" >
							@csrf
							<div class="box-content">
								...
								<div class="form-group-select">
									...
									<textarea type="text" class="form-control" name="description" value="{{old('description')}}"  placeholder="Enter Description" id="editor1"></textarea>
