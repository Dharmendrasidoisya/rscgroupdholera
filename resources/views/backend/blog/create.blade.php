...
<div class="d-flex flex-column flex-row-fluid wrapper" id="kt_wrapper">
	...
	<div class="container">
		<div class="row">
			...
			<h3 class="card-title"> Add Expertise</h3>
		</div>
		<!--begin::Form-->
			<div class="row">
				<div class="col-md-12">
						...
						<form method="post" action="{{route('admin.blogstore')}}" enctype='multipart/form-data'>
							...
							<div class="box-content">
								...
								<div class="form-group-select">
									...
									<div class="col-sm-6 col-lg-4 controls">
										<input name="shoutdescription" type="text" class="form-control" data-rule-required="true" data-rule-minlength="3" value="{{old('shoutdescription')}}"/>
										<span class="text-danger">
								...
								<div class="form-group-select">
									...
									<textarea type="text" class="form-control ckedspec" name="longdescription"  placeholder="Enter Long Description" id="full-featured-editor"></textarea>
