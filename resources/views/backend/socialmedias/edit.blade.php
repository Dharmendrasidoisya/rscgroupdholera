							...
							<div class="box-content">
								<div class="form-group-select">
									...
									<div class="col-sm-8 col-lg-8 controls">
										<input name="facebook" type="text" class="form-control" data-rule-required="true" data-rule-minlength="3" value="{{$socal->facebook}}"/>
								...
								<div class="form-group-select">
									...
									<div class="col-sm-8 col-lg-8 controls">
										<input name="twitter" type="text" class="form-control" data-rule-required="true" data-rule-minlength="3" value="{{$socal->twitter}}"/>
								...
								<div class="form-group-select">
									...
									<div class="col-sm-8 col-lg-8 controls">
										<input name="youtube" type="text" class="form-control" data-rule-required="true" data-rule-minlength="3" value="{{$socal->youtube}}"/>
								...
								<div class="form-group-select">
									...
									<div class="col-sm-8 col-lg-8 controls">
										<input name="linkedin" type="text" class="form-control" data-rule-required="true" data-rule-minlength="3" value="{{$socal->linkedin}}"/>
								...
								<div class="form-group-select">
									...
									<div class="col-sm-8 col-lg-8 controls">
										<input name="instagram" type="text" class="form-control" data-rule-required="true" data-rule-minlength="3" value="{{$socal->instagram}}"/>
								...
								<div class="form-group-select">
									...
									<div class="col-sm-8 col-lg-8 controls">
										<input name="pinterest" type="text" class="form-control" data-rule-required="true" data-rule-minlength="3" value="{{$socal->pinterest}}"/>
