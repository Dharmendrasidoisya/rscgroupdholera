...
<div class="d-flex flex-column flex-row-fluid wrapper" id="kt_wrapper">
	...
	<div class="container">
		<div class="row" style="margin-top:10px;">
			...
			<h3 class="card-title">Inquiry Sell Land View</h3>
            <a class="btn btn-primary addbtn" href="{{route('admin.selllandindex')}}" style="margin-bottom: 20px !important"><i class="fa fa-list" aria-hidden="true"></i>Back List</a>
		</div>
		<!--begin::Form-->							
		<div class="row">
            <div class="col-md-12">
