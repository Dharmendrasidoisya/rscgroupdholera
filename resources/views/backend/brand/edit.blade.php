						...
						<form method="post" action="{{route('admin.brandupdate',$brand->id)}}">
							...
							<div class="box-content">
								<div class="form-group-select">
									<label class="col-sm-3 col-lg-2 control-label" for="brand_name">Video<span style="color: #a94442;">*</span></label>
									<div class="col-sm-6 col-lg-4 controls">
										<input name="brand_name" type="text"class="form-control" data-rule-required="true" data-rule-minlength="3" value="{{$brand->brand_name}}"/>
